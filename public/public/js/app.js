        ...
        $('form#contact_add_form, form#contact_edit_form')
            ...
            .validate({
                ...
                submitHandler: function(form) {
                    ...
                    var myform = document.getElementById("contact_add_form");
                    if(myform==null){
                        var myform = document.getElementById("contact_edit_form");
                    }
					...
					// fd.append('signature_pro', $( '#signature_pro' )[0].files[0]);
					// fd.append('seconder_signature', $( '#seconder_signature' )[0].files[0]);
