                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
							<select class="form-control w-100" onchange="roomType(this.value)" required>
					...
					<div class="col-sm-6">
                        <div class="form-group">
							<select class="form-control w-100" id="getRooms" required>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                __('restaurant.select_correspondent'), 'id' => 'correspondent']); !!}
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
